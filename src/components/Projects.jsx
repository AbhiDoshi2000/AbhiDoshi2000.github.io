    ...
    return (
        <div className="max-w-sm sm:max-w-sm md:max-w-sm bg-gray-900 border border-neutral-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {title === 'CollabEd Portal' && (
                <a href="#">
                    <img className="w-full rounded-t-lg h-auto object-cover " src={CollabEd} alt="" />
                </a>
            )}
            {title === 'Travel Genie' && (
                <a href="#">
                    <img className="w-full rounded-t-lg h-auto object-cover " src={Travel} alt="" />
                </a>
            )}
            {title === 'Car Booking Management System' && (
                <a href="#">
                    <img className="w-full rounded-t-lg h-auto object-cover " src={Car} alt="" />
                </a>
            )}
...
export const project = [
    ...
    {
        title: 'Travel Genie',
        description: 'Discover your city or travel destination with our web app. Built with React and Material UI, it connects you to top attractions, restaurants, and hotels. Using Google APIs, enjoy live location-based searches with filters for ratings and rankings, ensuring a tailored exploration experience.',
        image: Travel,
        git: "",
